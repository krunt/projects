...
ID_INLINE idVec3::idVec3( const float *xyz )
{
   this->x = xyz[0];
   this->y = xyz[1];
   this->z = xyz[2];
...
ID_INLINE idVecX::idVecX(const idVecX &a) {
   size = alloced = 0;
   p= NULL;
