...
void idMat4::GetAxis(idVec3 &forward, idVec3 &left, idVec3 &up) const
{
   forward.x= mat[0].x; forward.y= mat[0].y; forward.z= mat[0].z;
   left.x= mat[1].x; left.y= mat[1].y; left.z= mat[1].z;
   up.x= mat[2].x; up.y= mat[2].y; up.z= mat[2].z;
}

void idMat4::GetTranslation(idVec3 &translation) const
{
...
void idMat4::SetAxis(const idVec3 &forward)
{
   idVec3 left, up;
   forward.OrthogonalBasis(left, up);

   mat[0].x= forward.x; mat[0].y= forward.y; mat[0].z= forward.z;
   mat[1].x= left.x; mat[1].y= left.y; mat[1].z= left.z;
   mat[2].x= up.x; mat[2].y= up.y; mat[2].z= up.z;
}

void idMat4::SetTranslation(const idVec3 &translation)
{
