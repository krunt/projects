...
public:
   ...
   const idVec3         &GetMin() const { return b[0]; }
   const idVec3         &GetMax() const { return b[1]; }
   idVec3               &GetMin() { return b[0]; }
   idVec3               &GetMax() { return b[1]; }

   float          SurfaceArea() const;

   int            GetMaximumExtentIndex() const;

   bool           IntersectRay(const idVec3 &start, const idVec3 &dir, float scale, float *hitt0, float *hitt1) const;
