...
{
public:
   static idFile *OpenFile(const char *filename, int mode);
   static idFile *OpenFileRead(const char *filename);
   static idFile *OpenFileWrite(const char *filename);
   static idFile *OpenFileAppend(const char *filename);
   static void    CloseFile(idFile *);
};
