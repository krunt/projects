...
split B 
    into C1 if SUBSTRING(start_time, 0, 10) eq '2014-01-19',
         C2 if SUBSTRING(start_time, 0, 10) eq '2014-01-20';

D = join C1 by (action_id, host, pid) LEFT, C2 by (action_id, host, pid);
